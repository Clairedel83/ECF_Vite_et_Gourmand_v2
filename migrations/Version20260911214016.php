 ...
 */
final class Version20260911214016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `condition` (id INT AUTO_INCREMENT NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE menu_condition (menu_id INT NOT NULL, condition_id INT NOT NULL, INDEX IDX_A496EF77CCD7E912 (menu_id), INDEX IDX_A496EF77887793B6 (condition_id), PRIMARY KEY (menu_id, condition_id)) DEFAULT CHARACTER SET utf8mb4');
