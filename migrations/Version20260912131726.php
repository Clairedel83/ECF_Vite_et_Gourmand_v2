 ...
 */
final class Version20260912131726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dessert ADD description LONGTEXT NOT NULL');
        ...
        $this->addSql('ALTER TABLE entree ADD description LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dessert DROP description');
        ...
        $this->addSql('ALTER TABLE entree DROP description');
